      ...
      */}
      {/* <div className="grid grid-cols-1 xl:grid-cols-10 gap-6 items-start"> */}
        ...
        {/* <div className="xl:col-span-7 w-full"> */}
          {/* 섹션 타이틀 */}
          <h2 className="text-xl font-bold text-blue-900 mb-6 px-2">
            AI 과실비율 조회
          </h2>
          ...
          <div className="flex flex-row items-center justify-between gap-4 w-full">
            ...
            {/* [좌측] 1. 사고 상황 입력 */}
            <div className="flex-1 bg-white border border-gray-100 rounded-2xl p-6 shadow-sm flex flex-col justify-between h-[380px]">
              <div>
            ...
            <div className="flex items-center justify-center text-blue-100 rounded-2xl p-6 shadow-sm flex flex-col justify-between h-[380px]">
              ➔
            </div>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <div className="flex items-center justify-center gap-8 my-2">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs font-medium text-gray-500 mt-1">A 차량 (직진)</p>
                </div>

                {/* 도넛 그래프 모양 원형 UI */}
                <div className="relative w-20 h-20 rounded-full border-[10px] border-blue-500 border-r-red-500 rotate-45 flex items-center justify-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs font-medium text-gray-500 mt-1">B 차량 (진입)</p>
                </div>
              </div>
              

              {/* 분석 요약 박스 */}
              <div className="bg-blue-50/50 border-blue-100 rounded-xl p-4 mb-auto">
                <h4 className="text-xs font-bold text-blue-950 mb-1.5">
                  분석 요약
                </h4>
                <p className="text-xs text-gray-600 leading-relaxed">
                  ...
                  단, 안전운전 의무에 따른 일부 과실이 인정됩니다.</span>
                </p>
              </div>
            </div>
          </div>

...
- 회원 관리: 본인확인, 가입 의사 확인, 불만 처리 등 민원 처리
- 서비스 제공: 과실비율 조회 기록 관리, 커뮤니티 작성자 식별
    ...
    <>
      ...
      <div className="auth-split-layout">
        ...
        <div className="auth-banner">
          <div className="banner-content">
            <h2>새로운 여정의 시작,<br/>FaultFinder와 함께</h2>
            <p>정확하고 투명한 과실비율 산정 서비스를 지금 바로 경험해 보세요.</p>
          </div>
        </div>
      ...
      {modalContent && (
        <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", backgroundColor: "rgba(0,0,0,0.5)", zIndex: 9999, display: "flex", justifyContent: "center", alignItems: "center" }}>
          <div style={{ backgroundColor: "#fff", width: "90%", maxWidth: "500px", maxHeight: "80vh", borderRadius: "12px", padding: "20px", display: "flex", flexDirection: "column", boxShadow: "0 10px 25px rgba(0,0,0,0.2)" }}>
            ...
            <button onClick={() => setModalContent(null)} style={{ marginTop: "15px", padding: "12px", backgroundColor: "#3b82f6", color: "white", border: "none", borderRadius: "8px", fontWeight: "bold", cursor: "pointer" }}>
              확인
            </button>
          </div>
        </div>
